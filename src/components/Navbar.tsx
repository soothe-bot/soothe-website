      ...
      <div className="mx-4 flex w-full max-w-7xl items-center justify-center text-left">
        ...
        <Link href="/">
          <div className="flex items-center gap-2">
            <Image src={logo} className="h-8 w-8 rounded-full md:h-10 md:w-10" alt="Soothe Logo" />
        ...
        <nav className="flex w-full justify-end gap-2 text-right">
          ...
          <a
            href="/invite"
            target="_blank"
            className="rounded bg-[#666666] text-black px-3 py-1.5 text-sm font-medium text-slate-300 transition-all duration-300 hover:bg-[#316945] md:text-base"
          >
            Add To Server
          </a>
        </nav>
