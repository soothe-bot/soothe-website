      ...
      <div className="flex w-full max-w-5xl flex-col gap-6 px-4 text-left lg:flex-row lg:gap-0">
        <div className="flex flex-col lg:min-w-max">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-slate-300">Soothe</h1>
          </div>
          <p className="mb-1 whitespace-pre-line">Soothe is not endorsed nor affiliated with Discord, Inc.</p>
          <div className="flex gap-3">
            <span>© {new Date().getFullYear()} Soothe. All rights reserved</span>
            {commitSha ? (
              <a
                href={`https://github.com/soothe-bot/soothe/commit/${commitSha}`}
                target="_blank"
            ...
            <a
              href="https://github.com/soothe-bot/soothe"
              target="_blank"
              rel="noopener noreferrer"
